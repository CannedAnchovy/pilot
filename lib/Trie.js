...
Trie.prototype.find = function (word) {
  ...
  var endTrieNode = this.getEndTrieNode(word);

  if (endTrieNode === undefined) return undefined;else return endTrieNode._value;
};
...
Trie.prototype.contains = function (word) {
  ...
  var endTrieNode = this.getEndTrieNode(word);
  if (endTrieNode === undefined) return false;else return endTrieNode._value.length !== 0;
};
